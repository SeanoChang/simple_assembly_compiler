...
int print_ops::addToBuffer(std::string str, StringBuffer* strBuffer) {
...
int var_stmt_ops::addToBuffer(std::string var, SymbolTable* sTable) {
...
int int_stmt_ops::addToBuffer(std::string var) {
...
int declscal_stmt_ops::addToBuffer(std::string symbol, SymbolTable* sTable) {
...
int declarr_stmt_ops::addToBuffer(std::string var1, std::string var2, SymbolTable* sTable) {
    // add the string to the symbol table
    int curLen = sTable -> getSymbolTableLength();
...
/* declare label */
int decllabel_stmt_ops::addToBuffer(std::string symbol, SymbolTable* sTable) {
...
int label_stmt_ops::addToBuffer(std::string symbol, SymbolTable* sTable) {
    // add the string to the symbol table
